...
export const metadata = {
  title: 'Settings - Vitalist Bay Events',
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl border border-red-200 p-6">
            ...
            <button className="px-4 py-2 border border-red-600 text-red-600 hover:bg-red-50 font-medium rounded-lg transition-colors">
              Delete Account
            </button>
          </div>
        </div>
